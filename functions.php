...
function kaka_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'kaka_content_width', 640 );
}
...
function kaka_scripts() {
	...
	wp_enqueue_script( 'kaka-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'kaka-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
